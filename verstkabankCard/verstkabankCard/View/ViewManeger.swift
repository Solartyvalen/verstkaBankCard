...
final class ViewManeger {
    ...
    let images: [UIImage] = [
        UIImage(resource: .icon1),
        UIImage(resource: .icon2),
        UIImage(resource: .icon3),
        UIImage(resource: .icon4),
        UIImage(resource: .icon5),
        UIImage(resource: .icon6)
    ]
    
    static let shared = ViewManeger()
    private init(){ }
    ...
    func getCollection(id: String, dataSourse: UICollectionViewDataSource, delegate: UICollectionViewDelegate) -> UICollectionView {
        let collection: UICollectionView = {
            ...
            collection.dataSource = dataSourse
